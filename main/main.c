...
void app_main(void)
{
    ...
    //     float thermocouple_temp = max31856_read_thermocouple_temp(&max31856_spi_handle);
    //     printf("MAX31856 Thermocouple Temperature: %.2f °C\n", thermocouple_temp);

    //     vTaskDelay(pdMS_TO_TICKS(1000)); // Read MAX31856 every 1 second
    // }
